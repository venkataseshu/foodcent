...
*/
require_once("class.phpmailerone.php");
require_once("formvalidatorone.php");
...
class FGMembersite
{
    ...
    {
        return isset($_SESSION['name_user'])?$_SESSION['name_user']:'';
    }
    
    function UserEmail()
    {
        return isset($_SESSION['email_user'])?$_SESSION['email_user']:'';
    }
    ...
    function SendUserConfirmationEmail(&$formvars)
    {
        ...
        $confirm_url = $this->GetAbsoluteURLFolder().'/confirmregone.php?code='.$confirmcode;
    ...
    function SaveToDatabase(&$formvars)
    {
        ...
        {
            $this->HandleError("This phone number is already registered");
            return false;
        }
