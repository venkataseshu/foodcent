...
<br>
<!--<span class="w3-pacifico w3-large w3-margin w3-padding-top">FOOD CENT</span><br><br>-->
<a class="w3-display-topleft w3-margin " href="index.php"><img src="img/login.svg" style="width:40px;height:40px;"></a>
<div class="q w3-display-middle"><img src="img/a.png"></div>
<div class="s w3-container w3-display-left w3-margin-left" style="color:white;"><span class="w3-pacifico w3-jumbo">Food Lover</span></div>
<div class="w3-container w3-display-right w3-margin-right ">
<form id='register' action='<?php echo $fgmembersite->GetSelfScript(); ?>' method='post' accept-charset='UTF-8'>
<span class="w3-pacifico w3-large">User Register</span><br><br>
...
<input class="w3-red"  type='text' name='name' id='name' placeholder="fullname" value='<?php echo $fgmembersite->SafeDisplay('name') ?>' maxlength="50" /><br/>
