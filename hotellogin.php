...
if(isset($_POST['submitted']))
{
   ...
   {
        $fgmembersite->RedirectToURL("q.php");
   }
}
...
<span class="w3-pacifico w3-large">Hotel Login</span><br><br>
...
<div class='w3-container'>
    <input class="w3-btn w3-white w3-text-red w3-round-xxlarge" type='submit' name='Submit' value='Login' />
 <a class="w3-btn w3-white w3-text-red w3-round-xxlarge" href="hotelregis.php" />Register</a>
</div><br/>
<div class='short_explanation'><a href='reset-pwd-reqone.php'>Forgot Password?</a></div>
